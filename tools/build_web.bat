...
REM    2. Diem vao la app_web.py (pywebview), khong phai auto_clicker_gui.py.
REM    3. VAN phai keo theo overlays.py + auto_clicker_gui.py + tkinter:
...
%PY% -m PyInstaller ^
  ...
  --hidden-import auto_clicker_gui ^
